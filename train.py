...
parser.add_argument('--image_size', dest='image_size', type=int, default=128, choices=[256, 512],
...
parser.add_argument('--embedding_num', dest='embedding_num', type=int, default=29,
